...
# SIDEBAR NAVIGATION
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
st.sidebar.title("🦁 SL Cricket Analytics")
st.sidebar.markdown("<span style='color: #94a3b8;'>Player Selection Intelligence System</span>", unsafe_allow_html=True)
...
page = st.sidebar.radio("Navigation", [
    ...
    "🌍 PLAYER vs OPPONENTS",
    "📊 TEAM PERFORMANCE",
    "🏏 RECOMMEND PLAYING XI"
])

st.sidebar.markdown("---")
st.sidebar.markdown("<small style='color: #94a3b8;'>Data: Cricsheet.org | Model: Random Forest</small>", unsafe_allow_html=True)
    ...
    if st.button("🔍 Generate Best XI", use_container_width=True):
        ...
        try:
            ...
            with c2:
                ...
                st.info("The system applies Random Forest models on rolling EWMA features to forecast. Below is the SHAP explanation for the top selected player.")
