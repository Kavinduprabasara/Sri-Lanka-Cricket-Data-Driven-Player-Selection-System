...
with st.sidebar:
    ...
    st.markdown("<p style='color: #94a3b8; font-size: 0.9em;'>Data-Driven Player Selection System</p>", unsafe_allow_html=True)
    ...
    page = option_menu(
        ...
        styles={
            ...
            "nav-link": {"font-size": "15px", "text-align": "left", "margin":"0px", "--hover-color": "#1e293b"},
            "nav-link-selected": {"background-color": "#0f172a", "font-weight": "bold", "border-left": "4px solid #f5c518"},
        }
    )
...
if page == "Squad Overview":
    ...
    st.markdown("""
        <div style='background-color: #0f172a; border-left: 3px solid #22c55e; padding: 10px; border-radius: 5px; margin-bottom: 15px;'>
    ...
    """, unsafe_allow_html=True)
    st.markdown(f"<span style='color: #94a3b8;'>Form window: Last 10 matches | Date: {datetime.now().strftime('%d %B %Y')}</span>", unsafe_allow_html=True)
    ...
    for i, row in form_df.iterrows():
        with cols[i % 3]:
            ...
            spark_fig.update_layout(margin=dict(l=0,r=0,t=0,b=0), xaxis_visible=False, yaxis_visible=False,
                                   ...
                                   showlegend=False)
            spark_fig.update_traces(marker_color='#f5c518')
    ...
    fig.add_trace(go.Scatter(x=unique_matches['match_date'], y=unique_matches['rolling_win_rate'],
                             mode='lines+markers', line=dict(color='#f5c518', width=3),
    ...
    fig.update_layout(paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)',
                      font=dict(color='#ffffff'), yaxis=dict(range=[0, 100], title="Win Rate %", gridcolor='#1e293b'),
                      xaxis=dict(gridcolor='#1e293b'), annotations=annotations)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    if len(p_df) == 0:
        ...
        fig.add_trace(go.Scatter(x=p_df['match_date'], y=p_df['rolling_10'],
                                 mode='lines', line=dict(color='#f5c518', width=2),
                                 name='10-Match Avg'))
        ...
        fig_f.update_layout(paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', font=dict(color='#ffffff'),
                            yaxis=dict(gridcolor='#1e293b', range=[0, 105]), xaxis=dict(gridcolor='#1e293b'))
        ...
        <div style="background-color: {col}20; border-left: 5px solid {col}; padding: 15px; border-radius: 4px;">
            ...
            <p style="margin:5px 0 0 0; color:#cbd5e1;">{subtit}</p>
        </div>
        """, unsafe_allow_html=True)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    if len(f_df) > 0:
        ...
        fig_v.update_layout(paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', font=dict(color='#ffffff'),
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    fig.add_vline(x=datetime.now().timestamp() * 1000, line_dash='dash', line_color='#f5c518', annotation_text="TODAY")
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    # Header Context
    st.markdown("""
    <div style='background-color: #1a3a6e; padding: 15px; border-radius: 8px; margin-bottom: 20px;'>
        <h3 style='margin:0; color:#f5c518;'>Upcoming Match Strategy</h3>
    ...
    if st.button("🔍 Generate Best XI", use_container_width=True):
        ...
        try:
                ...
                for i, row in selected.iterrows():
                    ...
                    <div class="custom-container" style="padding:10px; margin-bottom:8px;">
                        <div style="display:flex; justify-content:space-between;">
                            ...
                            <span style="color:#f5c518; font-weight:bold;">{round(row['adj_score'],1)}</span>
                        </div>
                    </div>
                    """, unsafe_allow_html=True)
            ...
            with c2:
                ...
                st.markdown("""
                    <div style='background-color: #0f172a; border-left: 3px solid #f5c518; padding: 10px; border-radius: 5px; margin-bottom: 15px;'>
                ...
                fig.update_layout(
                  ...
                  showlegend=True, paper_bgcolor='rgba(0,0,0,0)', font=dict(color='#ffffff')
                )
                st.plotly_chart(fig, use_container_width=True, theme=None)
